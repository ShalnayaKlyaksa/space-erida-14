...
public sealed partial class GradientMarkingEffect : MarkingEffect
{
    ...
    public override string ToString()
    {
        ...
        {
            { "offset", ParamToString(Offset) },
            { "size", ParamToString(Size) },
            { "rotation", ParamToString(Rotation) },
            { "speed", ParamToString(Speed) },
            { "pixelated", ParamToString(Pixelated) },
            { "mirrored", ParamToString(Mirrored) },
        };
    ...
    {
        return maybeOther is GradientMarkingEffect other
