...
[RegisterComponent, Access(typeof(EridaScenarioRuleSystem))]
public sealed partial class EridaScenarioRuleComponent : Component
{
    [DataField]
    ...
    [DataField]
    public LocId DifficultyOneAnnouncement = "erida-extended-difficulty-1";

    [DataField]
    public LocId DifficultyTwoAnnouncement = "erida-extended-difficulty-2";

    [DataField]
    public LocId DifficultyThreeAnnouncement = "erida-extended-difficulty-3";
